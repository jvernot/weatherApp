...
window.onload = function() {
    ...
    for (var i =0; i < storedCities.length; i++) {
        ...
        newCityEl = $("<li id='searchCards' class='list-group-item'>" + storedCities[i] + "</li>");
        
        $("#citySearches").append(newCityEl);
    }
    //running the function to display the last city searched
...
$("#searchButton").on("click", function(event){
    ...
    for (var i =0; i < storedCities.length; i++) {
        ...
        newCityEl = $("<li id='citybox' class='list-group-item'>" + storedCities[i] + "</li>");
